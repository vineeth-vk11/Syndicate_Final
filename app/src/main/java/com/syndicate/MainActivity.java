...
import com.syndicate.CompaniesHelper.CompaniesFragment;
import com.syndicate.DealersHelper.DealersFragment;
import com.syndicate.NavigationHelper.CompanyProfileFragment;
import com.syndicate.NavigationHelper.EditProfileFragment;
import com.syndicate.NavigationHelper.SalesHeadProfileFragment;
import com.syndicate.NavigationHelper.SalesNotificationsFragment;
import com.syndicate.SalesHelper.SalesDashboardActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(type.equals("head")){
            ...
            osLimit = intent.getStringExtra("osLimit");
        }
        ...
        if(type.equals("head")){
            ...
            bundle.putString("osLimit",osLimit);
