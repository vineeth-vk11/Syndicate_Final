    ...
    private void getTransactions(){
        ...
        db.collection("Companies").document(company).collection("sales").document(sales).collection("dealers")
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                Log.i("openingCredit",String.valueOf(openingCreditAmount));
                Log.i("openingDebit",String.valueOf(openingDebitAmount));
                Log.i("currentCredit",String.valueOf(currentCredit));
                Log.i("currentDebit",String.valueOf(currentDebit));
                Log.i("openingBalance",String.valueOf(openingBalance));
                ...
                Collections.reverse(transactionsModelArrayList);
